...
final dummyUsers = [
  ...
  UserModel(
    id: 'user2',
    name: 'Abdallah Essa',
    avatarPath: 'https://randomuser.me/api/portraits/men/2.jpg',
    isOnline: false,
  ),
  UserModel(
    id: 'user3',
  ...
  UserModel(
    id: 'user8',
    name: 'Zainab',
    avatarPath: 'https://randomuser.me/api/portraits/women/3.jpg',
    isOnline: false,
  ),
  UserModel(
    id: 'user9',
  ...
  UserModel(
    id: 'user10',
    name: 'Mariam',
    avatarPath: 'https://randomuser.me/api/portraits/women/5.jpg',
    isOnline: false,
  ),
];
